...
public class ElectronicsController {
     ...
     * @param modelNo
     */
    public void searchByModelNo(String name, String pw) {
    	try {
    		SuccessView.printSearchByModelNo(service.searchByModelNo(name, pw));
        } catch (Exception e) {
        	FailView.errorMessage(e.getMessage());
        }
    } 
     ...
     * @param electronics
     */
    public void update(Person electronics) {
    	try {
    ...
    public void saveObject() {
    	try {
    		service.saveObject();
    		SuccessView.printMessage("Saving data complete.");
    	} catch (Exception e) {
    		FailView.errorMessage(e.getMessage());
    	}
    }
