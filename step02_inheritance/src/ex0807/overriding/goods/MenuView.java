...
public class MenuView{
  ...
  */
  public void inputInsert(){
       ...
       EndView.printMessage(goods.getCode() +result.getMessage());
       } else EndView.printMessage(result.getMessage());
//       switch(result) {
//       case INSERT_OUTOFINDEX:
// 		  EndView.printMessage(result.getMessage());
//       case INSERT_DUPLICATE:
// 		  EndView.printMessage(code+InsertResult.INSERT_DUPLICATE.getMessage());
//       case INSERT_SUCCESS:
//            EndView.printMessage(InsertResult.INSERT_SUCCESS.getMessage());
//       }
